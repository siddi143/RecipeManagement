...
border:none;
 ...
 <body>
 <div id="div">
 <form name="form" action="veg">
  <h1>Veg Recipe Form</h1>  
  ...
  <input type="text" id="ingredients" name="ingredients" value="" class="input" required><br><br>
   <section id="app">
    <div class="container">
      ...
      <div class="row">
        <div class="col-6">
      <textarea type="text" id="description" name="description" value="" class="input" placeholder="Descrption about the receipe" v-model="newItem" @keyup.enter="addItem()"></textarea>
      </div><!-- End col -->
      </div><!--End Row -->
    </div><!--End Container -->
  </section><!-- end App -->
